    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-[440px]">
        <DialogHeader>
          ...
          <DialogDescription className="text-[13px] text-[#666360]">
        ...
        <div className="space-y-2 px-1 py-2">
          <Label htmlFor="confirm-username" className="text-[13px] text-[#2C2C2A]">
        ...
        <DialogFooter className="flex justify-end gap-2 border-t border-[#E8E6DF] px-1 pt-3">
          <Button
            variant="outline"
